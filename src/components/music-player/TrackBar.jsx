    ...
    <div className={isSticky ? "musicplayer_trackbar musicplayer_trackbar_fixed bg-gray-900" : "musicplayer_trackbar"}>
      ...
      <div className="musicplayer_trackbar_currenttime p-2">
        ...
        <div className="flex gap-2 justify-center">
          ...
          <button onClick={fastForward} className="p-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
        ...
        {isLoading ? (
          ...
          <div style={{ height: 22 }} className="w-full flex flex-col items-center">
      ...
      <div className="musicplayer_trackbar_volume p-2">
        <div className="w-full flex flex-col items-center">
          <div className="flex">
            ...
            <label className="mx-1 text-sm">{Math.round(volume * 100)}%</label>
          </div>
